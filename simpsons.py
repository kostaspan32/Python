...
x = randrange(len(family["father"]["quotes"]))
print('Father Random Quote: ' + family["father"]["quotes"][x])

x = randrange(len(family["mother"]["quotes"]))
print('Mother Random Quote: ' + family["mother"]["quotes"][x])

x = randrange(len(family["children"][0]["quotes"]))
print('Child0 Random Quote: ' + family["children"][0]["quotes"][x])
